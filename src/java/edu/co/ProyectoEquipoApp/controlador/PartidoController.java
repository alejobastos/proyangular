...
import edu.co.ProyectoEquipoApp.entidades.Partido;
import edu.co.ProyectoEquipoApp.controlador.util.JsfUtil;
import edu.co.ProyectoEquipoApp.controlador.util.JsfUtil.PersistAction;
...
public class PartidoController implements Serializable {
    ...
    @EJB
    private edu.co.ProyectoEquipoApp.controlador.PartidoFacade ejbFacade;
    ...
    public Partido getPartido(java.lang.Integer id) {
    ...
    public static class PartidoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getPartido(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Partido) {
                ...
                return getStringKey(o.getPartidoid());
            } else {
